...
En conjunto, estas limitaciones no invalidan el sistema desarrollado, sino que más bien delimitan su alcance. El proyecto se centra en construir y validar un flujo completo de entrenamiento, inferencia, evaluación, y finamente la interfaz. 