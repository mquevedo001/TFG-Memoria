La comunicación entre módulos es la definida en el diagrama de flujo que se presenta en la Figura \ref{fig:DiagramaFlujo}.
...
\begin{itemize}
    ...
    \item 8. Durante entrenamiento se almacenan los checkpoints; durante evaluación y despliegue se almacenan métricas, JSON, gráficos y audios en los directorios de resultados.
\end{itemize}
