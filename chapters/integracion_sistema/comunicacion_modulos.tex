...
El núcleo principal de la configuración entre módulos son los archivos \textit{main.py} y \textit{config.py}. En el archivo main se decide
la acción que se va a ejecutar y se llama a una función que lleva a cabo la tarea requerida. Previamente se cambian valores del archivo config, por ejemplo, la función de pérdida.
