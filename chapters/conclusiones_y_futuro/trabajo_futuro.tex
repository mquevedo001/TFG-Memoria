...
Por otro lado, sería también un punto a favor estudiar la implementación de estructuras de arquitectura híbridas que combinen informacion en el dominio temporal con información en el dominio tiempo-frecuencia.  El sistema trabaja con magnitudes de la STFT y aplica la fase de la mezcla sobre las magnitudes de las fuentes para reconstruir las fuentes. Los modelos híbridos
