...
\begin{itemize}
    ...
    \item \textbf{Demucs / Hybrid Demucs: } modelo avanzado que, en función del tipo de pista de entrada, toma como entrada su espectrograma, su onda, o ambos. De los estados más modernos en el campo \cite{HybridDemucs}.
\end{itemize}
