...
\begin{itemize}
    \item Las primeras versiones del entrenamiento permitieron detectar problemas de formato, inferencia y evaluación.
    \item Las pérdidas simples o directas sobre magnitud, son más fáciles de interpretar y sirven como base comparativa.
    ...
    \item Las pérdidas avanzadas con fase o reconstrucción temporal son mas complejas y, por tanto, conviene añadir control sobre ellas, piden cautela.
\end{itemize}