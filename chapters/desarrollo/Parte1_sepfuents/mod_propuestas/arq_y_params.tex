...
\begin{itemize}
    ...
    Para los parámetros, se tuvo que realizar una segunda versión de estos, ya que, tras considerar una tanda de entrenamientos realizada como válida, al evaluar se llegó a la conclusión de que los parámetros del modelo base y los parámetros de nuestros entrenamientos no coincidían, lo que llevó a incompatibilidad entre \textit{checkpoints}, configuración y \textit{forward} y por ello, se decidió realizar una segunda tanda de entrenamientos con los parámetros corregidos que se muestran a continuación:
    \begin{table}[H]
    \centering
    \begin{tabular}{ll}
    \hline
