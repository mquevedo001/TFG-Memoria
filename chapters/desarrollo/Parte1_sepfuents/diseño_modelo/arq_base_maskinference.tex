...
La arquitectura LSTM es comúnmente utilizada en separación de fuentes por su capacidad de retener información, de olvidarla,de análisis secuencial y de mantener contexto pasado y futuro de la información actual.
Una LSTM procesa una secuencia paso a paso, normalmente palabras, sonidos o datos en general que se definen a lo largo de un eje temporal.

En el contexto del proyecto el sistema introduce al modelo la interpretación en secuencia temporal de un espectrograma (es decir, la magnitud de la STFT de la entrada), a partir del cuál, la LSTM procesa esta secuencia para estimar máscaras que aplicadas sobre
