...
\begin{itemize}
    \item En las primeras versiones del entrenamiento se detectaron problemas de formato, inferencia y evaluación. El proyecto terminó habiendose realizado tres tandas de entrenamientos diferentes corrigiendo estos errores, de las cuales la última es la definitiva.
    ...
    \item Las pérdidas avanzadas con fase o reconstrucción temporal son mas complejas y, por tanto, conviene añadir control sobre ellas.
\end{itemize}