...
El reentrenamiento numero tres corresponde a la versión actual y a la que ha proporcionado los resultados que se muestran en esta memoria. Nace en respuesta a lo visto y aprendido en la versión anterior.
...
\begin{itemize}
    ...
    \item Se guarda un sumario de configuración de entrenamiento por modelo, lo queayuda a hacer un seguimiento a posteriori.
