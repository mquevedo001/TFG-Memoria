...
\begin{itemize}
    ...
    \item Falla la generación del waveform o espectrograma de una fuente.
...
Por cada fuente separada el sistema permite al usuario guardar una copia en su equipo. Esto estaría pensado para una situación real en la que este sistema está \textit{hosteado} en un servidor y no en ejecución local ya que en ejecución local no hace falta descargar nada.Ver Figura \ref{fig:descarga-gui}.
