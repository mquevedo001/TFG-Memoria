...
Siendo:
\begin{itemize}
    \item $Y$ la magnitud objetivo de la fuente.
    \item $\hat{Y}$ la magnitud estimada.
    \item $X$ la magnitud de la mezcla.
    \item $\hat{M}$ la máscara estimada.
    \item $N$ el número de elementos comparados.
    \item $\epsilon$ constante para evitar división o logaritmos de cero.
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{adjustbox}{max width=\textwidth}
        ...
        \end{tabular}
    \end{adjustbox}
    \caption{Pérdidas principales consideradas durante el entrenamiento.}
    \label{tab:perdidas-principales}
\end{table}

\subsubsection{Pérdidas avanzadas o experimentales}
...
\begin{table}[H]
    ...
    \begin{adjustbox}{max width=\textwidth}
        ...
        \end{tabular}
    \end{adjustbox}
    \caption{Pérdidas avanzadas y experimentales consideradas durante el desarrollo.}
