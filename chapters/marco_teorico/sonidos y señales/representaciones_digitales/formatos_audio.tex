...
Aunque por lo general, en procesamiento de audio, se utilizan otro tipo de espectrogramas: los espectrogramas de Mel (explicados en el siguiente párrafo). El uso el espectrograma estándar en el proyecto se debe que el objetivo del modelo es estimar máscaras tiempo-frecuencia que posteriormente se aplican sobre la magnitud STFT de la mezcla para reconstruir las fuentes usando la fase de la mezcla.
