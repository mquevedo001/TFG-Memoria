...
El trabajo abarca la implementación de distintas funciones de pérdida (\textit{L1, L2}, pérdidas en frecuencia, pérdidas de máscara, entre otras), el entrenamiento controlado de modelos con una misma configuración de hiperparámetros, y la evaluación del rendimiento obtenido a través de diferentes métricas.
